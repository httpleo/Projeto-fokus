...
const iniciarOuPausarBtIcone = document.querySelector(".app__card-primaty-butto-icon")
...
const cardButton = document.querySelector('.app__card-primary-button');

const startPauseButton = document.getElementById('.app__card-primary-button');
